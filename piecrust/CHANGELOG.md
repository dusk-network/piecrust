...
- Switch `dusk-wasmtime` to upstream Wasmtime `44.0.2`, rewriting active data-segment initialization into a Piecrust-managed one-shot initializer so restored contract memory is not reset.
