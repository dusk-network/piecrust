...
- Gate `rkyv` validation behind the `abi` feature.

## [0.21.0] - 2026-06-12

### Added

- Add `reverted` field to `Event` struct
...
<!-- VERSIONS -->
[Unreleased]: https://github.com/dusk-network/piecrust/compare/uplink-0.21.0...HEAD
[0.21.0]: https://github.com/dusk-network/piecrust/compare/uplink-0.20.0...uplink-0.21.0
